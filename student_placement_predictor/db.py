...
# DATABASE CONNECTION
# ─────────────────────────────────────────
# Hard-coded clean URL — strips all whitespace to prevent sslmode parse errors
_RAW_URL = os.getenv(
    "DATABASE_URL",
    "postgresql://postgres:mypassword123@127.0.0.1:5432/placement_db_student"
)
# Remove ALL whitespace characters (spaces, newlines, tabs) from the URL
DATABASE_URL = "".join(_RAW_URL.split())
